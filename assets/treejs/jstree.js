 ...
 */
	...
	var instance_counter = 0,
		...
		_d = document, _node = _d.createElement('LI'), _temp0, _temp1, _temp2, _temp3, _temp6;
	...
	_temp2.setAttribute('title', 'modifica');
	_temp1.appendChild(_temp2);
	_temp2 = _d.createElement('I');
	_temp2.className = 'cerchietto';
    _temp2.setAttribute('title', 'seleziona');
	_temp1.appendChild(_temp2);
	_temp6 = _d.createElement('I');
	_temp6.className = 'fa fa-sort-amount-desc';
    _temp6.setAttribute('title', 'includi figli');
	_temp1.appendChild(_temp6);
	_temp0.appendChild(_temp1);
	_temp1 = _d.createElement('SPAN');
